<template>
  <div class="bg-white pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8">
    <div class="relative max-w-lg mx-auto divide-y-2 divide-gray-200 lg:max-w-7xl">
      <div>
        <h2 class="text-3xl tracking-tight font-extrabold text-gray-900 sm:text-4xl">Blog</h2>
      ...
      <div class="mt-12 grid gap-16 pt-12 lg:grid-cols-3 lg:gap-x-5 lg:gap-y-4">
        ...
        <NuxtLink to="/historique" class="block p-4 rounded-lg hover:bg-gray-50">
          ...
          <div class="mt-4">
            ...
            <p class="mt-3 text-base text-gray-500">
              Retrouver l'historique des mises à jour de la plateforme.
            </p>
          </div>
        </NuxtLink>
        <NuxtLink to="/sites-partenaires" class="block p-4 rounded-lg hover:bg-gray-50">
          ...
          <div class="mt-4">
            ...
            <p class="mt-3 text-base text-gray-500">
              Découvrez d'autres observatoires à travers le pays, dont certains sont, comme le nôtre, basés sur la plateforme Open Source Cyclopolis.
            </p>
          </div>
        </NuxtLink>
      </div>
