      ...
      <div class="mt-12 grid gap-16 pt-12 lg:grid-cols-3 lg:gap-x-5 lg:gap-y-4">
        ...
        <NuxtLink to="/historique" class="block p-4 rounded-lg hover:bg-gray-50">
          ...
          <div class="mt-4">
            ...
            <p class="mt-3 text-base text-gray-500">
              Retrouver l'historique des mises à jour de la plateforme REVMRN.
            </p>
          </div>
        </NuxtLink>
        <NuxtLink to="/sites-partenaires" class="block p-4 rounded-lg hover:bg-gray-50">
          ...
          <div class="mt-4">
            ...
            <p class="mt-3 text-base text-gray-500">
              Découvrez d'autres observatoires à travers le pays, dont certains, comme le nôtre, sont basés la plateforme Open
              Source Cyclopolis.
            </p>
          </div>
        </NuxtLink>
